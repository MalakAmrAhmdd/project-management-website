...
export function getAllocationStatus(pct: number): "over" | "optimal" | "under" | "unallocated" {
...
export function computeOverallVelocity(totalPoints: number, start: string | null | undefined, end: string | null | undefined): string {
